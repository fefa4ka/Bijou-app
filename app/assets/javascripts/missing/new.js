$(function(){
	...
	$(".b-form__save_button").click(function(){
		$("#new_missing").attr('action', '/missings/new');
		$("#new_missing input[name=_method]").val('post');
	...
	function search_for_similar() {                     
		...
		$.getJSON('/missings/new/search_for_similar.json', { name: name, gender: gender, age: age},  function(data) {
            var items = [];
